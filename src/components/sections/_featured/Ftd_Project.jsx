...
import { Ftd_Expanded, Tech, Styled_Button, Styled_Icons } from '@components'
            ...
            >
                ...
                <motion.div
                    className={`p-4
                        ${
                            isSm
                                ? 'flex-col-top mt-10 max-w-[40vw] transform-gpu space-y-10 rounded-xl bg-grey-lightest py-10 shadow-md dark:bg-grey-darker'
