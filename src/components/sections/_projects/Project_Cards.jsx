...
import { Tech, Styled_Icons } from '@components'
    ...
    hrefs.map((href, i) => {
        ...
        return (
            <a key={`project-link-${i}`} href={href} title={title} {...props}>
                <Styled_Icons invert={true} name={name} size={size} />
            </a>
        )
    })
    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                variants={projectCardVariants.contentView}
            >
                <ProjectTitle
                    title={title}
                ...
                <div className="flex-evenly mb-2 w-full space-x-3">
                    <Tech
                        tech={tech}
                        className="text-center text-sm tracking-tighter dark:text-grey-light/90 dark:brightness-110"
                    />
                </div>
