...
const Title = ({ setTitleVis }) => {
    return (
        <svg width="100%" height="100%" viewBox="0 -25 360 75">
            <g stroke="#010" strokeWidth={2} vectorEffect="non-scaling-stroke">
                <motion.path
                    initial="hidden"
                    animate="visible"
                    variants={draw}
                    custom={1}
                    d="M 6.2 38.6 L 0 38.6 L 0 3.6 L 5.35 3.6 L 20.65 29.15 L 17.85 29.15 L 32.9 3.6 L 38.25 3.6 L 38.3 38.6 L 32.15 38.6 L 32.1 13.25 L 33.4 13.25 L 20.6 34.6 L 17.7 34.6 L 4.7 13.25 L 6.2 13.25 L 6.2 38.6 Z"
                    id="0"
                />
                <motion.path
                    initial="hidden"
                ...
                <motion.path
                    ...
                    variants={draw}
                    custom={7}
                    d="M 192.6 38.6 L 186.35 38.6 L 186.35 1.5 L 192.6 1.5 L 192.6 38.6 Z"
                    id="6"
                />
                <motion.path
                    initial="hidden"
